...
//            // act
//             var memoryStream = await downloader.DownloadFileTaskAsync(URL).ConfigureAwait(false);
...
//        {
//            // arrange
//            var dir = new DirectoryInfo("D://musics/");
//            var downloader = new DownloadService(Config);
...
//            // assert
//            Debug.Log(File.Exists(downloader.Package.FileName));
//            Debug.Log(downloader.Package.FileName);
...
//            Debug.Log(progressChangedCount <= progressCounter);
//            Debug.Log(100.0==downloader.Package.SaveProgress);
//            Debug.Log(downloader.Package.IsSaveComplete);
//            Debug.Log(downloader.Package.IsSaving);
//        }
...
//            double expectedAverageSpeed = (256 * 16 + 512 * 8 + 1024 * 4 + 2048 * 2) / 30; // == (256*16 + 512*8 + 1024*4 + 2048*2)/30
//            double averageSpeed = 0;
//            var progressCounter = 0;
