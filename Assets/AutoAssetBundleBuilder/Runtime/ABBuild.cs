...
namespace ZionGame
{
    ...
    public class ABBuild : ScriptableObject, ABIData
    {
        ...
        [Tooltip("To run with bundles in the Editor, " +
            "the version string must match a currently web-hosted version, " +
            "or a set of bundles built locally and in the Cached Bundle folder.")]
        ...
        [Tooltip("This is automatically configured during the build process " +
            "based on the setting in ABBuildConfig for this platform." +
            "\nIf you manually enable it in the ABEditorConfig, " +
            "it will only load asset bundles from the /StreamingAssets/ folder while in the Editor as well." +
