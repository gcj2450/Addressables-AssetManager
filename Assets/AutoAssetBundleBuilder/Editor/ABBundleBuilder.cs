...
namespace ZionGame
{
    ...
    public class ABBundleBuilder
    {
        ...
        static public void DoOverrideBundleBuild(ABBuildInfo buildInfo, ABBuild existingBuild)
        {
            ...
            string manifestFullPath = ABUtilities.GetRuntimeCacheFolder(ABBuildVersion.GetUpdatedVersion()) + "/manifest-" + existingBuild.buildVersion + ".json";
            ...
            if (overrideAssets.Count > 0)
            {
                ...
                if (unityManifest == null)
                    Debug.LogError("<color=#ff8080>[" + existingBuild.platform + "] Asset bundle build failed for " + buildMap[0].assetBundleName + "</color>");
            ...
            string manifestPath = ABUtilities.GetRuntimeCacheFolder(ABBuildVersion.GetUpdatedVersion()) + "/override-" + existingBuild.buildVersion + ".json";
            File.WriteAllText(manifestPath, manifestJson, System.Text.Encoding.UTF8);
        }
