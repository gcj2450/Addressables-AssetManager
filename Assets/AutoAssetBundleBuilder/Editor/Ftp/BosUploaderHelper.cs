...
//        /// 上传文件夹到Bos
//        /// </summary>
//        /// <param name="_localFolderName"></param>
//        /// <param name="_ftpFolderName"></param>
//        /// <param name="platformStr"></param>
//        /// <returns></returns>
//        public Task<bool> UploadFolderTask(string _localFolderName, string _ftpFolderName, string platformStr)
//        {
//            Task<bool> task = new Task<bool>(() => UploadToBosWithResult(_localFolderName, _ftpFolderName, platformStr));
//            task.Start();
//            return task;
//        }
...
//        /// 上传文件到Bos
//        /// </summary>
//        /// <param name="_localFilePath"></param>
//        /// <param name="_remoteFileKey"></param>
//        /// <param name="platformStr"></param>
//        /// <returns></returns>
//        public Task<bool> UploadFileTask(string _localFilePath, string _remoteFileKey, string platformStr)
//        {
//            Task<bool> task = new Task<bool>(() => UploadFileToBosWithResult(_localFilePath, _remoteFileKey, platformStr));
//            task.Start();
//            return task;
//        }
...
//        /// <param name="_ftpFolderName"></param>
//        /// <param name="platformStr"></param>
//        bool UploadToBosWithResult(string _localFolderName, string _ftpFolderName, string platformStr)
//        {
//            string url = "http://test-bd-b-rd0001.bcc-bddwd.baidu.com:8090/api/v1/client/editor/resource/dev/bos/acquire";
//            //线上推送接口
//            //string url = "http://test-bd-b-rd0001.bcc-bddwd.baidu.com:8090/api/v1/client/editor/resource/online/bos/acquire";
...
//                    upResult = !string.IsNullOrEmpty(putObjectFromFileResponse.ETAG);
//                }
//            }
//            return upResult;
...
//        /// <summary>
//        /// 上传单个文件到bos平台
//        /// 远程文件名需要类似格式：/baidu/verfolder/config_win64.txt
//        /// </summary>
//        /// <param name="_localFilePath">本地文件路径</param>
//        /// <param name="_remoteFileKey">远程文件名，可以像路径一样带斜杠"/"用于模拟文件夹</param>
//        /// <param name="platformStr"></param>
//        public bool UploadFileToBosWithResult(string _localFilePath, string _remoteFileKey, string platformStr)
//        {
//            string url = "http://test-bd-b-rd0001.bcc-bddwd.baidu.com:8090/api/v1/client/editor/resource/dev/bos/acquire";
//            //platform可选：ios,android,windows
//            string json = "{\"unique_path\": \"baidu\",\"engine\": \"unity\",\"platform\": \"" + platformStr + "\"}";
...
//                PutObjectResponse putObjectFromFileResponse =
//            client.PutObject(bos_path_prefix, _remoteFileKey, fileInfo);
//                //这里putObject无进度和成功提示，只有一个putObjectFromFileResponse的ETAG，
//                //暂且用这个字符串判断成功与否
//                return !string.IsNullOrEmpty(putObjectFromFileResponse.ETAG);
//            }
//            else
//                return false;
//        }
...
//        /// <param name="_remoteFileKey">远程文件名，可以像路径一样带斜杠"/"用于模拟文件夹</param>
//        /// <param name="platformStr"></param>
//        public void UploadFileToBos(string _localFilePath, string _remoteFileKey, string platformStr)
//        {
//            string url = "http://test-bd-b-rd0001.bcc-bddwd.baidu.com:8090/api/v1/client/editor/resource/dev/bos/acquire";
//            //platform可选：ios,android,windows
//            string json = "{\"unique_path\": \"baidu\",\"engine\": \"unity\",\"platform\": \"" + platformStr + "\"}";
